...
export const myWorkExperiences: workInfo[] = [
  {
    ...
    skills: ['Pivotal Cloud Foundry', 'Reactive Java', 'Jenkins', 'Java', 'Spring Boot'],
  },
  {
    company: 'Mastercard',
    companyImageSrc: 'mastercard.jpg',
  ...
  },
  {
    ...
    skills: ['Kubernetes', 'Ruby on Rails', 'LDAP', 'React', 'Docker'],
  },
  {
  ...
  },
  {
    ...
    skills: ['JavaScript', 'CSV', 'Front-end Development', 'API Integration'],
  },
  {
    company: 'Command Alkon',
    companyImageSrc: 'command-alkon.png',
    ...
    skills: ['Ruby', 'OCR Technology', 'API Development', 'Automation', 'Data Processing'],
  },
];
