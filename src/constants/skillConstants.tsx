...
export const mySkills: skillInfo[] = [
  { title: "JS", proficiency: 90, icon: <DiJavascript1 size={SKILL_ICON_SIZE} /> },
  ...
  { title: "Node", proficiency: 88, icon: <DiNodejs size={SKILL_ICON_SIZE} /> },
  { title: "Python", proficiency: 89, icon: <DiPython size={SKILL_ICON_SIZE} /> },
  { title: "React", proficiency: 92, icon: <DiReact size={SKILL_ICON_SIZE} /> },
  ...
  { title: "Rails", proficiency: 91, icon: <SiRubyonrails size={SKILL_ICON_SIZE} /> },
  ...
  { title: "PSQL", proficiency: 80, icon: <SiPostgresql size={SKILL_ICON_SIZE} /> },
  ...
  { title: "Spring Boot", proficiency: 92, icon: <BiLogoSpringBoot size={SKILL_ICON_SIZE} /> },
