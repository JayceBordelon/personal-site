  ...
  return (
      <section id="contact">
        ...
        <form id="form" onSubmit={handleSubmit}>
          ...
          {emailState === SENDING && <FloatingInView><h3>Sending...</h3></FloatingInView>}
          {emailState === ERROR && <FloatingInView threshold={0.2} ><div onClick={() => openLinkInNewTab("mailto:b.jayce@wustl.edu")} className='error-text'>There was an issue sending your mail at this time. Try reaching me at b.jayce@wustl.edu. Sorry for the inconvinience</div> </FloatingInView>}
          {emailState === SENT && <FloatingInView threshold={0.2} ><div className='success-text'>Check your email!!</div> </FloatingInView>}
        </form>
      </section>
  );
}
